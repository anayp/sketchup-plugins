module PointFiveInchPipes
  # Simple logger to the Ruby console.
  def self.log(msg)
    puts "[0.5inchPipes] #{msg}"
  end
  ...
  def self.create_cylinders_from_lines
    ...
    # The circle's radius is 0.5 inch
    radius       = 0.5
    ...
    edges.each_with_index do |edge, index|
      ...
      # 1) Draw a circle in XY plane (local coords), radius 0.5 inch
  ...
  unless file_loaded?(__FILE__)
    UI.menu("Plugins").add_item("0.5inch Radius Pipes") {
